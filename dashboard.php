        ...
        <div class="left-sidebar">
            ...
            <div class="sidebar-user-pro media border-end">                    
                <div class="position-relative mx-auto">
                    <img src="dashboard/assets/images/users/user-4.jpg" alt="user" class="rounded-circle thumb-md">
                           ...
                           <!--end nav-->
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse " id="sidebarPages">
                                    <ul class="nav flex-column">
                                       <li class="nav-item">
                                            <a class="nav-link" href="dashboard/pages-profile.html">Profile</a>
                                        </li><!--end nav-item-->
                                        <li class="nav-item">
                                            <a class="nav-link" href="dashboard/pages-blog.html">Blog</a>
                                        </li><!--end nav-item-->
                                        <li class="nav-item">
            ...
            <nav class="navbar-custom" id="navbar-custom">    
                <ul class="list-unstyled topbar-nav float-end mb-0">
                    <li class="dropdown">
                        ...
                        <img src="dashboard/assets/images/flags/india.png" alt="" class="thumb-xxs rounded">
                    </a>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="d-flex justify-content-between mb-3">
                                ...
                                <div class="media">
                                    <img src="dashboard/assets/images/logos/btc.png" class="me-2 thumb-sm align-self-center rounded-circle" alt="...">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 align-self-center mb-3 mb-lg-0">
                                                <div class="met-profile-main">
                                                    <div class="met-profile-main-pic">
                                                        <img src="dashboard/assets/images/users/user-4.jpg" alt="" height="110" class="rounded-circle">
                                                    ...
                                                    <div class="met-profile_user-detail">
                                                        ...
                                                        <p class="mb-0 met-user-name-post">Full Stack Developer, India</p>                                                        
                                                    </div>
                                                </div>                                                
                                            </div><!--end col-->
                                            ...
                                            <div class="col-lg-4 ms-auto align-self-center">
                                                <ul class="list-unstyled personal-detail mb-0">
                                                    <li class=""><i class='bx bx-phone' ></i> <b> phone </b> : +91 9693570288</li>
                                                    <li class="mt-2"><i class='bx bx-envelope' ></i> <b> Email </b> : shivamraj8378@gmail.com</li>
                                                    <li class="mt-2"><i class='bx bx-globe' ></i> <b> Website </b> : 
                                                        <a href="https://shivamraj.in.net" class="font-14 text-primary">https://shivamraj.in.net</a> 
                                                    </li>                                                   
                                                </ul>
